const mypet, textName, textAge, textMessage, query, findPet;

//buttons and form
const createPetBtn = document.getElementById("create");
const readPetBtn = document.getElementById("read");
const updatePetBtn = document.getElementById("update");
const deletePetBtn = document.getElementById("delete");
